...
##############################################################################
# Note: Generated by soapfish.xsd2py at 2017-10-17 17:29:28.059616
...
Schema_6d88b = xsd.Schema(
    imports=[],
    includes=[],
    targetNamespace='augo/smev/uslugi/1.0.0',
    elementFormDefault='qualified',
    simpleTypes=[AgentType, Sex, S6, S10, S50, S120, S1024],
    attributeGroups=[],
    groups=[],
    complexTypes=[Address, AppliedDocument, LegalEntity, Individual],
